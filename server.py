...
from topology_mapper import _classify_interface, _build_topology_snapshot  # noqa: F401
from topology_ui import TOPOLOGY_UI_CONTENT
...
# ─────────────────────────────────────────────────────────────────────────────
# Shared WiFi state — live data written by _wifi_polling_task, read by topology_mapper
_wifi_clients = topology_state.wifi_clients
# Structure: {ap_mac: {client_mac: {signal, bitrate, connected, last_seen}}}

_wifi_iface_status = topology_state.wifi_iface_status
...
# _classify_interface lives in topology_mapper.py — imported at top of file.
...
# Business logic lives in topology_mapper.py — only thin route handlers here.
# ─────────────────────────────────────────────────────────────────────────────
